...
builder.Services.AddMassTransit(configurator =>
{
    ...
    configurator.UsingRabbitMq((context, _configure) =>
    {
        ...
        _configure.ReceiveEndpoint("order-created-queue", e =>
...
MongoDBService service= scope.ServiceProvider.GetService<MongoDBService>();
...
if (!stockCollection.FindSync(session => true).Any())
{
    ...
    await stockCollection.InsertOneAsync(new() { ProductId = Guid.NewGuid().ToString(), Count = 6, CreatedDate = DateTime.UtcNow });
